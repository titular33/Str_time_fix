...
namespace SRT
{
    ...
    public class SRTFile
    {
        ...
        /// <summary>
        /// Lista de todos os subtitulos 
        /// </summary>
        public List<Subtitle> Subtitles = new List<Subtitle>();

        /// <summary>
        /// Pegando o endpoint final do arquivo
        /// </summary>
        ...
        /// <summary>
        /// Pegar todos os subtitulos em um espaço de tempo
        /// </summary>
        ...
        /// <summary>
        /// Fazendo o Parse do srt.file
        /// </summary>
        /// <param name="strSRTFile"></param>
        /// <param name="enc">Encoding. E usado durante a leitura do .srt file. </param>
                ...
                for (int i = 0; i < lines.Length; i++)
                {
                    ...
                    switch (state)
                    {
                        case 0: //Começo da linha
                            ...
                            break;
                        case 1: //depois do numero do subtitle 
    ...
    public class SRTTime
    {
        ...
        /// <summary>
        /// Criar um novo SRTTime object da string.
        /// </summary>
        /// <param name="strTime">string em hh:mm:ss,milli </param>
        ...
        /// <summary>
        /// Criar uma nova SRTTime obj para o case  de millisegundos.
        /// </summary>
        ...
        /// <summary>
        /// Multiplicando utilizando a origin (00:00:00).
        /// </summary>
        public void Multiply(double factor)
        {
        ...
        /// <summary>
        /// Parses a string inno formato hh:mm:ss,milli
        /// </summary>
        ...
        /// <summary>
        /// Gets e sets dos millisegundos totais.
        /// </summary>
        ...
        /// <summary>
        /// Renders SRTTime object no formato hh:mm:ss,milli
        /// </summary>
        /// <returns></returns>
